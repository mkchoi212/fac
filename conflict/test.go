...
var ccDiffCheck = []string{
	"CircularCrownSelector.swift:145: leftover conflict marker",
	"CircularCrownSelector.swift:153: leftover conflict marker",
	"CircularCrownSelector.swift:161: leftover conflict marker",
	"CircularCrownSelector.swift:164: trailing whitespace.",
	"+    let red = CGFloat(arc4random())",
	"CircularCrownSelector.swift:165: trailing whitespace.",
	"+    let green = CGFloat(arc4random())",
	"CircularCrownSelector.swift:166: trailing whitespace.",
	"+    let blue = CGFloat(arc4random())",
	"CircularCrownSelector.swift:168: trailing whitespace.",
	"+  }",
	"CircularCrownSelector.swift:169: leftover conflict marker",
}
